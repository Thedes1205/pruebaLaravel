                ...
                <div class="col-lg-6 col-md-6 d-flex flex-column align-items-center justify-content-center">
                  ...
                  <div class="card mb-3">
                    ...
                    <div class="card-body border border-info rounded-3 border border-5">
                      ...
                      <h5 class="card-title text-center fw-bold fs-2"><img  class="text-left" src="{{asset('assets/img/solicitud.png')}}">Solicitud {{$registration->registration_number}}</h5>

                      <!-- General Form Elements -->
                      <form id="solicitud" Action="#" method="post" class="needs-validation" novalidate>
                        @csrf
                        @method('PATCH')
                        <div class="row mb-3">
                          <label for="registration_number" class="col-sm-3 col-form-label">Nº Registro</label>
                          <div class="col-sm-9">
                            <input disabled type="number" class="form-control"  required name="registration_number" id="registration_number"  value="{{old('registration_number') ?? $registration->registration_number}}">
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-9">
                            <input disabled type="text" class="form-control" required name="firstname" id="firstname"  value="{{old('firstname') ?? $registration->firstname}}">
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-9">
                            <input disabled type="text" class="form-control" required name="lastname" id="lastname"  value="{{old('lastname') ?? $registration->lastname}}">
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-9">
                            <input disabled type="number" class="form-control" required name="age" id="age"  value="{{old('age') ?? $registration->age}}" pattern="[0-9]{2}">
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-9">
                            <input disabled type="text" class="form-control" required name="gpa" id="gpa"  value="{{old('gpa') ?? $registration->gpa}}">
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-9">
                            <input disabled type="text" class="form-control" required name="code" id="code"  value="{{old('code') ?? $registration->code}}">
                            <div class="invalid-feedback">Por favor introduce un dato numerico de 10 digitos</div>
                            @error('code')
                            <div  class="mt-2 alert alert-danger">{{$message}}</div>
                            @enderror
                          </div>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-9">
                            <input disabled type="text" class="form-control" required name="phone" id="phone"  value="{{old('phone') ?? $registration->phone}}" pattern="[0-9]{10}" title="Ingrese un número telefonico valido">
                        ...
                        <div class="row mb-2">
                          ...
                          <div class="col-sm-9">
                            <select disabled class="form-select" id="gender" name="gender" aria-label="Default select example" value="{{old('gender') ?? $registration->gender}}" required>
                              <option></option>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-9">
                            <input disabled type="text" name="career" id="career" class="form-control" value="{{old('career') ?? $registration->career}}" required>
                            <div class="invalid-feedback">Por favor introduce solo texto</div>
                            @error('career')
                            <div  class="mt-2 alert alert-danger">{{$message}}</div>
                            @enderror
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-9">
                            <input disabled type="number" name="grade" id="grade" class="form-control" value="{{old('grade') ?? $registration->grade}}" required>
                            <div class="invalid-feedback">Por favor introduce un dato numerico no mayor a dos digitos</div>
                            @error('grade')
                            <div  class="mt-2 alert alert-danger">{{$message}}</div>
                            @enderror
                        ...
                        <div class="row mb-2">
                          ...
                          <div class="col-sm-9">
                            <select disabled class="form-select" id="shift" name="shift" aria-label="Default select example" required>
                              <option></option>
                        ...
                        <div class="row mb-2">
                          ...
                          <div class="col-sm-9">
                            <input disabled type="text" name="school" id="school" class="form-control" value="CUCEI" readonly>
                          </div>
                          @error('school')
                            <div  class="mt-2 alert alert-danger">{{$message}}</div>
                            @enderror
                        ...
                        <div class="row mb-2">
                          ...
                          <div class="col-sm-9">
                            <input disabled type="text" name="place" id="place" class="form-control" value="Guadalajara" readonly>
                          </div>
                          @error('place')
                            <div  class="mt-2 alert alert-danger">{{$message}}</div>
                            @enderror
                        ...
                        <div class="row mb-2">
                          ...
                          <div class="col-sm-9 has-validation">
                            <select disabled class="form-select" id="modality" name="modality" value="{{old('modality') ?? $registration->modality}}" id="modality" aria-label="Default select example" required>
                        ...
                        {{-- <div class="col-12">
                          <div class="form-check">
                            <input disabled class="form-check-input"disabled  name="terms" type="checkbox" value="" id="acceptTerms" required>
